 ...
 * @author main
 */
public class Employer extends ModeratableUser implements Position {
    ...
    public Employer(int userID, String companyName, String address, String recruiterName, String email, int phoneNumber, String password, boolean status) {
    ...
    public String toString() {
        // int userID, String companyName, String address, String recruiterName, String email, int phoneNumber, String password, boolean status
